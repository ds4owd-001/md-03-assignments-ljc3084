...
1.  Look at the plot that you created. What do you notice about the order of the bars / order of the legend? \# In Uganda's context there is still a big problem of unimproved sanitation facilities. Though there has been an improvement from 2000 to 2020, but it is just 0.9 improvement nation wide.
2.  What would you want to change? \# I would increase funding and would implore the Ministry of Health to intervene with purpose and tangible plans and solutions.
3.  Why did we remove "safely managed sanitation services" from the data set in Task 3? \# From the graph it is evident that the percentage of safely managed sanitation services is negligable at 0%.

## Task 7

1.  Run the code in the code chunk below.
2.  What do you observe when you look at the code and plot? #Basic sanitation has improved globally according to the graphs.
