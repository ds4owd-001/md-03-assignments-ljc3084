...
4.  How many observations are in the data set? #344 observations
5.  What data types are contained in the variables? (Reminder: <https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables>) \# 3 different datatypes int, fct, dbl
...
penguins %>% 
  ...
  summarise(bill_depth_mean = mean(bill_depth_mm), na.nm = TRUE,
            bill_length_mean = mean(bill_length_mm), na.nm = TRUE)
